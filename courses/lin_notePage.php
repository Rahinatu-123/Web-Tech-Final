...
try {
    $topicStmt = $pdo->prepare("SELECT topicId, topicName FROM topics WHERE courseId = 3");
    $topicStmt->execute();
...
<body>
    <header class="calculus-header">
        ...
        <button class="questions-btn" onclick="window.location.href='linear_question.php';">Questions</button>
    </header>
