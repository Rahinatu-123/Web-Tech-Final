...
try {
    $topicStmt = $pdo->prepare("SELECT topicId, topicName FROM topics WHERE courseId = 6");
    $topicStmt->execute();
...
<body>
    <header class="calculus-header">
        ...
        <button class="questions-btn" onclick="window.location.href='py_question.php';">Questions</button>
    </header>
