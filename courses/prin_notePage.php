...
try {
    $topicStmt = $pdo->prepare("SELECT topicId, topicName FROM topics WHERE courseId = 5");
    $topicStmt->execute();
...
<head>
    ...
    <title>Principles of Economics Notes</title>
...
<body>
    <header class="calculus-header">
        <h1>Principles of Economics Notes</h1>
        <button class="questions-btn" onclick="window.location.href='princ_question.php';">Questions</button>
    </header>
