...
try {
    $topicStmt = $pdo->prepare("SELECT topicId, topicName FROM topics WHERE courseId = 4");
    $topicStmt->execute();
...
<body>
    <header class="calculus-header">
        <h1>Database Management Systems Notes</h1>
        <button class="questions-btn" onclick="window.location.href='data_question.php';">Questions</button>
    </header>
